<?php
  ...
  {
    if(@$_GET['demail'] && $_SESSION['key']=='ganesh1689') 
    {
      $demail=@$_GET['demail'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='ganesh1689') 
    {
      $eid=@$_GET['eid'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='ganesh1689') 
    {
      $name = $_POST['name'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addqns' && $_SESSION['key']=='ganesh1689') 
    {
      $n=@$_GET['n'];
      $eid=@$_GET['eid'];
      $ch=@$_GET['ch'];
  ...
  if(@$_GET['q']== 'quiz' && @$_GET['step']== 2) 
  {
    ...
    else if( $_SESSION['key']!='ganesh1689')
    {
